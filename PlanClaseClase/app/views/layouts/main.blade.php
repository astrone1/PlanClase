...
<html lang="es">
    <head>
        ...
        <meta name="description" content="UTEM">
        <!--<link rel="icon" href="../../favicon.ico">-->

        <title>Planificacio´n Clase a Clase</title>
            ...
            <nav class="navbar navbar-default" role="navigation">
                <div class="container-fluid">
                    <div class="navbar-header">
                        <a class="navbar-brand" href="#" target="_blank">Inicio</a>
                    </div>
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li <?php if (Request::is('Dirdoc')) { echo 'class="active"'; } ?>><a href="http://postulacion.utem.cl/" target="_blank">Código</a></li>
                            <?php 
                            if(Auth::check()) {
                                ?>
                            ...
                            <?php
                                ...
                                ?>
                                <li <?php if (Request::is('Registro')) { echo 'class="active"'; } ?>><a href="login">Login</a></li>
                                <?php
                            }
                            ?>
                        </ul>
                        <ul class="nav navbar-nav navbar-right">
                            <li class="active"><a href="#">Out.</a></li>
                        </ul>
                    </div><!--/.nav-collapse -->
                </div><!--/.container-fluid -->
            </nav>
